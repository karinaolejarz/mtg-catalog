...
class FilterWhite extends Component {

  componentDidMount() {
    fetch('https://api.scryfall.com/cards/search?q=c%3Awhite+set=m21')
...
<div className="List" style={{display:"flex",flexWrap:"wrap", justifyContent:"center"}}>
  ...
  >
  <div class="po-pup" style={{background:"white", width:"100%", display:"flex"}}>
    <span>
